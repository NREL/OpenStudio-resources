...
class InteriorPartitionSurface_Test < Test::Unit::TestCase
  ...
  def test_hierarchy
    ...
    vertices << OpenStudio::Point3d.new(1.0,0.0,0.0)
    vertices << OpenStudio::Point3d.new(1.0,0.0,1.0)
    vertices << OpenStudio::Point3d.new(0.0,0.0,1.0)
    surface = OpenStudio::Model::InteriorPartitionSurface.new(vertices,model)

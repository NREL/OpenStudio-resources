...
#  NOTE: the next variable is custom to the script in the testing repository
#  ENERGYPLUS_EXAMPLES_DIR - path to the examples dir
#
# Example usage:
...
FOREACH(PATH ${ENERGYPLUS_POSSIBLE_PATHS})
  ...
  IF( IS_MATCH )
    ...
    FIND_PATH(ENERGYPLUS_EXAMPLES_DIR "1ZoneEvapCooler.idf" PATHS "${PATH}/ExampleFiles" "${PATH}/Examples" NO_DEFAULT_PATH)
  ENDIF( IS_MATCH )

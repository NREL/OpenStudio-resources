...
class TimeDependentValuationFixture : public ::testing::TestWithParam< std::pair<std::string,std::string> >
{
 public:
  // initialize for each test
  virtual void SetUp();
  ...
  static boost::optional<openstudio::FileLogSink> logFile;
  static openstudio::model::Model m_model;
};
...
class IntersectionFixture : public ::testing::Test { 
 protected:
  ...
  // set up logging
  REGISTER_LOGGER("IntersectionFixture");

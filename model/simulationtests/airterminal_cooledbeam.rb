...
hotWaterDemandBypass = OpenStudio::Model::PipeAdiabatic.new(model)
...
zones.each do |z|
  coilCooledBeam = OpenStudio::Model::CoilCoolingCooledBeam.new(model)
  chilledWaterPlant.addDemandBranchForComponent(coilCooledBeam)
  airTerminalCooledBeam = OpenStudio::Model::AirTerminalSingleDuctConstantVolumeCooledBeam.new(model,model.alwaysOnDiscreteSchedule(),coilCooledBeam)
...
#add thermostats
model.add_thermostats({"heating_setpoint" => 0,
                      "cooling_setpoint" => 28})

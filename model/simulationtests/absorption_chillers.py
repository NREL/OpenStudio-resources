...
condenser_plant = cts[0].plantLoop().get()
chilled_plant = chillers[0].plantLoop().get()

chiller = openstudio.model.ChillerAbsorptionIndirect(model)
chilled_plant.addSupplyBranchForComponent(chiller)
condenser_plant.addDemandBranchForComponent(chiller)

chiller = openstudio.model.ChillerAbsorption(model)
chilled_plant.addSupplyBranchForComponent(chiller)
condenser_plant.addDemandBranchForComponent(chiller)

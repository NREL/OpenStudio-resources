...
model.getSurfaces.each do |surface|
  ...
  movableInsulation = OpenStudio::Model::SurfaceControlMovableInsulation.new(surface)
  movableInsulation.setInsulationType("Outside")
  movableInsulation.setMaterial(material)

...
supp_heat = openstudio.model.CoilHeatingElectricMultiStage(model)
supp_heat.setName("Multi Stage Sup Elec Htg Coil")
supp_heat.setAvailabilitySchedule(always_on)
supp_heat_stage_1 = openstudio.model.CoilHeatingElectricMultiStageStageData(model)
supp_heat_stage_1.setEfficiency(0.95)
supp_heat_stage_1.setNominalCapacity(42000)
supp_heat_stage_2 = openstudio.model.CoilHeatingElectricMultiStageStageData(model)
supp_heat_stage_2.setEfficiency(0.9)
supp_heat_stage_2.setNominalCapacity(43000)
supp_heat_stage_3 = openstudio.model.CoilHeatingElectricMultiStageStageData(model)
...
fan = openstudio.model.FanConstantVolume(model, always_on)
heat = openstudio.model.CoilHeatingElectricMultiStage(model)
heat.setName("Multi Stage Elec Htg Coil")
heat.setAvailabilitySchedule(always_on)
heat_stage_1 = openstudio.model.CoilHeatingElectricMultiStageStageData(model)
heat_stage_1.setEfficiency(1)
heat_stage_1.setNominalCapacity(45000)
heat_stage_2 = openstudio.model.CoilHeatingElectricMultiStageStageData(model)

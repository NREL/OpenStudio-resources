...
vrf_fluid_temperature_control = openstudio.model.AirConditionerVariableRefrigerantFlowFluidTemperatureControl(model)
...
vrf_fluid_temperature_control.setOutdoorUnitEvaporatingTemperatureFunctionofSuperheatingCurve(
...
vrf_fluid_temperature_control.setOutdoorUnitCondensingTemperatureFunctionofSubcoolingCurve(

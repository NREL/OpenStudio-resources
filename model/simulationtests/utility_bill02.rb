...
electric_bill = OpenStudio::Model::UtilityBill.new("Electricity".to_FuelType, model)
...
gas_bill = OpenStudio::Model::UtilityBill.new("Gas".to_FuelType, model)

...
single_speed_evap_cooler = openstudio.model.EvaporativeFluidCoolerSingleSpeed(model)
plant.addSupplyBranchForComponent(single_speed_evap_cooler)

single_speed_cooler = openstudio.model.FluidCoolerSingleSpeed(model)
plant.addSupplyBranchForComponent(single_speed_cooler)

two_speed_cooler = openstudio.model.FluidCoolerTwoSpeed(model)
plant.addSupplyBranchForComponent(two_speed_cooler)

two_speed_evap_cooler = openstudio.model.EvaporativeFluidCoolerTwoSpeed(model)

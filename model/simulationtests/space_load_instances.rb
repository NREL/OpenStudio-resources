...
spaces.each_with_index do |space, i|
  if i == 0
    ...
    steam_eq.setName("#{space.name.to_s} Steam Equipment")
    ...
    gas_eq.setName("#{space.name.to_s} Gas Equipment")
    ...
    hw_eq.setName("#{space.name.to_s} HotWater Equipment")
    ...
    luminaire_eq.setName("#{space.name.to_s} Luminaire")

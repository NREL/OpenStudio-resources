...
custom_block = openstudio.model.CustomBlock(material, 2, 2, 4)
foundation_kiva.addCustomBlock(custom_block)
custom_blocks = []
custom_blocks.append(openstudio.model.CustomBlock(material, 3, 2, 5))
custom_blocks.append(openstudio.model.CustomBlock(material, 4, 2, 6))

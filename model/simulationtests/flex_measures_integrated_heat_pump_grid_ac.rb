...
grid_response_cooling_coil = OpenStudio::Model::CoilCoolingDXVariableSpeed.new(model)
grid_response_cooling_coil_speed_1 = OpenStudio::Model::CoilCoolingDXVariableSpeedSpeedData.new(model)
grid_response_cooling_coil.addSpeed(grid_response_cooling_coil_speed_1)
grid_response_cooling_coil.setGridSignalSchedule(grid_signal_schedule)
grid_response_cooling_coil.setLowerBoundToApplyGridResponsiveControl(100)
grid_response_cooling_coil.setUpperBoundToApplyGridResponsiveControl(-100)
grid_response_cooling_coil.setMaxSpeedLevelDuringGridResponsiveControl(10)
grid_response_cooling_coil.setLoadControlDuringGridResponsiveControl("SenLat")

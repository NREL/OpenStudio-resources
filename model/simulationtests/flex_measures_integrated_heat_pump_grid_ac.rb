...
grid_resp_cooling_coil = OpenStudio::Model::CoilCoolingDXVariableSpeed.new(model)
grid_resp_cooling_coil_speed_1 = OpenStudio::Model::CoilCoolingDXVariableSpeedSpeedData.new(model)
grid_resp_cooling_coil.addSpeed(grid_resp_cooling_coil_speed_1)
grid_resp_cooling_coil.setGridSignalSchedule(grid_signal_schedule)
grid_resp_cooling_coil.setLowerBoundToApplyGridResponsiveControl(100)
grid_resp_cooling_coil.setUpperBoundToApplyGridResponsiveControl(-100)
grid_resp_cooling_coil.setMaxSpeedLevelDuringGridResponsiveControl(10)
grid_resp_cooling_coil.setLoadControlDuringGridResponsiveControl('SenLat')

coil_system = OpenStudio::Model::CoilSystemIntegratedHeatPumpAirSource.new(model, space_cooling_coil, space_heating_coil)
coil_system.setGridResponseCoolingCoil(grid_resp_cooling_coil)
